...
public class FirstPersonController : MonoBehaviour
{
    ...
    public static Action<float> OnTakeDemage;
    ...
    [SerializeField] private Vector3 crouchingCenter = new Vector3(0, 0.5f, 0);     //Is in crouch animation
    [SerializeField] private Vector3 standingCenter = new Vector3(0, 0, 0);         //Time to crouch/stand
    private bool isCrouching;                                                       //Standing center point
    private bool duringCrouchAnimation;                                             //Crouching center point
    ...
    private void ApplyDemage(float dmg)
    {
        currentHealth -= dmg;
        currentHealth = Mathf.Clamp(currentHealth, 0, maxHealth); // Clamp the health value between 0 and maxHealth
